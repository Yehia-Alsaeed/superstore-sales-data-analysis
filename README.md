...
- 7.22% of cleaned orders resulted in negative profit.
...
This is a completed portfolio version of the Superstore sales analytics project. The repository is organized to show the analysis workflow clearly for review, learning, and future extension.
